...
/* -----------------------------------------------------------
   DAILY NEWS ARTICLES — FIXED FOR DELIVERY SDK v2
----------------------------------------------------------- */
...
/* -----------------------------------------------------------
   Get multiple entries — FIXED TYPES
----------------------------------------------------------- */
...
/* -----------------------------------------------------------
   Get entry by URL — FIXED FOR DELIVERY SDK v2
----------------------------------------------------------- */
export const getEntryByUrl = async <T>(
  ...
  try {
    ...
    referenceFieldPath?.forEach((path) =>
